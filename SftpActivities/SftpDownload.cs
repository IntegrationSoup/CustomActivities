...
namespace SftpActivities
{
    ...
    [OutMessage(@"TVNIfF5+XCZ8U2VuZGluZ0FwcHxTZW5kaW5nRmFjaWxpdHl8UmVjZWl2aW5nQXBwfFJlY2VpdmluZ0ZhY2lsaXR5fDIwMjUwMzAxMDkwMHx8QURUXkEwMXwxMjM0NXxQfDIuNS4x", TypeOfMessages.Binary)]
    public class SftpDownload : SftpActivityBase
    {
        public override void Process(IWorkflowInstance workflowInstance, IActivityInstance activityInstance, Dictionary<string, string> parameters)
        {
            ...
            activityInstance.ResponseMessage.SetText(Convert.ToBase64String(response.Bytes));
        }
    }
}
