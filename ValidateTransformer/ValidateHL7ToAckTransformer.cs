    ...
    public class ValidateHL7ToAckTransformer : CustomActivity
    {
        public override void Process(IWorkflowInstance workflowInstance, IActivityInstance activityInstance, Dictionary<string, string> parameters)
        {
            ...
            IHL7Message hl7Message = ValidationActivity.GetRequiredInputMessage(
                workflowInstance,
                activityInstance,
                nameof(ValidateHL7ToAckTransformer),
            ...
            try
            {
                ...
                ValidationActivity.HandleInvalidOutcome(workflowInstance, responseMessage, outcome, errorIfInvalid, promoteResponse: true);
            }
            finally
            {
